...
namespace WEB_Asystent.Controllers
{
    public class konfigRozmiarController : Controller
    {
        ...
        [HttpPost]
        public JsonResult PostUsunBlokadeWysokosci(UserModel data) // dodanie nowego bloku do zakladki do uzytkownika
        {
            var listaModeli = new List<BlokModel>();
            // test here!
            if (data != null)
            {
                ...
                //   wyszukany.WskaznikUstawieniaWymiaruPrzezUzytkownika = true;
                //  wyszukany.dodajBloki(data.formblok.n, data.formblok.orientacja);
                podstawa.UsunBlokadeWysokosci(wyszukany.BlokujeWysokosc);
        ...
        [HttpPost]
        public JsonResult PostUsunBlokadeSzerokosci(UserModel data) // dodanie nowego bloku do zakladki do uzytkownika
        {
            var listaModeli = new List<BlokModel>();
            // test here!
            if (data != null)
            {
                ...
                //   wyszukany.WskaznikUstawieniaWymiaruPrzezUzytkownika = true;
                //  wyszukany.dodajBloki(data.formblok.n, data.formblok.orientacja);
                podstawa.UsunBlokadeSzerokosci(wyszukany.BlokujeSzerokosc);
